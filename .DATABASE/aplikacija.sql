...
INSERT INTO `administrator` (`administrator_id`, `username`, `password_hash`) VALUES
	(1, 'Milan', '7507C1D8676E96687FCDE6E93BD00BB1B8E44ADAA710904DF0EBABE2CBA9E04C7031F380CB90DD1F10C80449B32970C525DC40B0EB04D60FBB4D53D3ADF68A80'),
	(2, 'test_user', '7507C1D8676E96687FCDE6E93BD00BB1B8E44ADAA710904DF0EBABE2CBA9E04C7031F380CB90DD1F10C80449B32970C525DC40B0EB04D60FBB4D53D3ADF68A80'),
	(3, 'pperic', 'D409D48E63E0BD2B64C2F856F7B818828BECF6BFF2E58A32F4E18C1CB805E28455AB55243D73E800FC6F9CFDEA367A763CF30508641C2F3F2731069776CC7871'),
	...
	(7, 'test', '4B5E74FF29E697CDFC077C0F0F739148FA9C5035DEE48E11CBC5D6D979D721A0C1423C411B36714B9130B669B2F87AE30FA8E969A80789EE287B57FCD20F3AB9');
...
CREATE TABLE IF NOT EXISTS `article` (
  ...
  `desktription` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `article` (`article_id`, `name`, `category_id`, `excerpt`, `desktription`, `status`, `is_promoted`, `created_at`) VALUES
	(1, 'ACME HDD 512GB', 5, 'Kratak opis', 'Detaljan opis', 'available', 0, '2020-12-08 21:42:22'),
	(2, 'AcmeHD11 1024GB', 5, 'Kratak opis', 'Neki malo duži text o prouizvodu 2', 'available', 1, '2020-12-09 12:00:12'),
	(3, 'AcmeHD11 1024GB', 5, 'Kratak opis', 'Neki malo duži text o prouizvodu 2', 'available', 1, '2020-12-12 16:16:43');
...
CREATE TABLE IF NOT EXISTS `article_price` (
  `article_price_id` int NOT NULL AUTO_INCREMENT,
  `article_id` int unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `article_price` (`article_price_id`, `article_id`, `price`, `created_at`) VALUES
	(1, 1, 45.00, '2020-12-08 22:02:05'),
	(2, 1, 43.56, '2020-12-08 22:02:23'),
	(3, 2, 56.89, '2020-12-09 12:00:12'),
	(4, 3, 56.89, '2020-12-12 16:16:43');
...
INSERT INTO `category` (`category_id`, `name`, `image_path`, `parent__category_id`) VALUES
	...
	(2, 'Kućna elektronika', 'assets/home.jph', NULL),
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `cart_id` int unsigned NOT NULL DEFAULT '0',
  `status` enum('rejected','accepted','shiped','pending') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'pending',
...
DROP TABLE IF EXISTS `phote`;
CREATE TABLE IF NOT EXISTS `phote` (
...
DELETE FROM `phote`;
/*!40000 ALTER TABLE `phote` DISABLE KEYS */;
INSERT INTO `phote` (`photo_id`, `article_id`, `image_path`) VALUES
	(1, 1, 'images/1/front.jpg'),
	(2, 1, 'images/1/label.jpg'),
	(3, 2, '20201210-1248053681-hard-disk-slika.jpeg'),
	(5, 2, '20201211-4525919638-css_sprites.jpeg');
/*!40000 ALTER TABLE `phote` ENABLE KEYS */;
...
INSERT INTO `user` (`user_id`, `email`, `password_hash`, `forename`, `surename`, `phone_number`, `postal_address`) VALUES
	(1, 'test@test.ba', 'A857CE52D3B87B2731E19AE4C2917C9A994C3FE2AA3EE86FF4176360D42D53886B63AC87F105A15D1D9370099D11F11E394D7A224298D3F89C929E1AF7D0CE94', 'Milan', 'Sormaz', '0', 'Neka ulica bez brojha u Banjaluci');
